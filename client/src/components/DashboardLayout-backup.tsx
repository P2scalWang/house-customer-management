...
function DashboardLayoutContent({
  ...
  return (
    <>
      ...
      <SidebarInset className="bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        {isMobile && (
        ...
        <main className="flex-1 p-4 transition-colors duration-200">{children}</main>
      </SidebarInset>
    </>
  );
}
